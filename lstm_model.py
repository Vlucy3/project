...
ax.legend()
plt.tight_layout()
plt.savefig(DATA_DIR / "lstm_training_curve.png", dpi=150)
plt.show()
print("Training curve saved to lstm_training_curve.png")

# ── 11. SAVE MODEL ────────────────────────────────────────────────────────────
torch.save({"model_state": best_weights, "scaler": scaler, "features": FEATURES}, DATA_DIR / "lstm_model.pt")
...
out_path = DATA_DIR / "lstm_submission.csv"
